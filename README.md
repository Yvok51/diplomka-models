...
- `multilabel.py` - trains the multilabel CANINE models, both the base one and the one with negative sampling depending whether the \texttt{--negative-sampling} flag is provided.

The tokenizers for the models are located in the \texttt{trainer\_output} directory.
