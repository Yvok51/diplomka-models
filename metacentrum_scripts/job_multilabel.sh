...
MODEL_PATH="multilabel_${PORTION}_${TYPE}_output"
venv/bin/python3 src/multilabel.py --samples-per-language 20000 --model-path "${MODEL_PATH}" --batch-size 16 --synthetic-proportion "${PORTION}" --model-type "${TYPE}"
